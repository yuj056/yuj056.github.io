...
where the s<sub>k is the net molar production rate of surface species, &sigma represents the site occupancy number of each species and &Gamma means the total site density.
